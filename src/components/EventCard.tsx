    ...
    <article className="group flex flex-col overflow-hidden rounded-2xl border border-[#2a2a35] bg-[#16161a] card-hover">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          ...
          {isSoldOut && (
            <span className="rounded-full bg-rose-500/20 text-rose-400 border border-rose-500/30 px-2.5 py-1 text-xs font-medium">
              Sold Out
            </span>
          )}
        </div>
      ...
      <div className="flex flex-1 flex-col p-5 gap-3">
        <div className="flex items-start justify-between gap-2">
          ...
          {event.price === 0 ? (
            <span className="rounded-full bg-green-500/10 border border-green-500/20 px-2 py-0.5 text-xs font-medium text-green-400">
              Free
            </span>
          ) : (
            <span className="text-xs font-semibold text-[#e8e6e1]">
        ...
        <p className="text-sm text-[#7c7a76] line-clamp-2 leading-relaxed">
          {event.description}
        </p>
        ...
        <div className="space-y-1.5 text-xs text-[#7c7a76]">
          ...
          <div className="flex items-center gap-2">
            <Clock className="h-3.5 w-3.5 text-amber-500/60 shrink-0" />
            <span>
          ...
          <div className="flex items-center gap-2">
            <Users className="h-3.5 w-3.5 text-amber-500/60 shrink-0" />
            <span
              className={`${
                isSoldOut
                  ? "text-rose-400"
