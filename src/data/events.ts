...
export const EVENTS: Event[] = [
  ...
  },
  {
    ...
    description: "An intensive 3-day bootcamp covering Python, scikit-learn, TensorFlow, and real-world ML pipelines.",
    fullDescription: "This intensive 3-day bootcamp is designed for developers, data analysts, and curious minds who want to break into AI and machine learning. Covering everything from Python fundamentals and data preprocessing to neural networks and model deployment, participants will build three complete ML projects by the end of the camp. Laptops required. Certificates awarded on completion.",
    date: "2025-08-20",
  ...
  },
  {
    ...
    description: "An exclusive evening of networking, cocktails, and great conversations for professionals across industries.",
    fullDescription: "Step above the city skyline for an exclusive evening of meaningful connections. The Rooftop Networking Mixer brings together founders, creatives, engineers, and professionals for curated conversations, delicious cocktails, and live ambient music. Speed-networking rounds, open bar, and stunning views of Nairobi at night. Dress code: Smart casual.",
    date: "2025-07-28",
  ...
  },
  {
    ...
    description: "A weekend celebrating Kenyan cuisine, street food, craft beers, and live entertainment in Karura Forest.",
    fullDescription: "The Nairobi Food Festival returns for its 5th edition — a two-day celebration of food, culture, and community inside the beautiful Karura Forest. Over 60 food vendors, cooking demonstrations, a cocktail village, live music across three stages, and a kids' zone make this Nairobi's most anticipated social event of the year. Tickets include forest entry. Rain or shine.",
    date: "2025-08-02",
  ...
  },
  {
    ...
    description: "Compete in Nairobi's biggest inter-company 5-a-side football tournament. 32 teams. One trophy.",
    fullDescription: "Gather your squad and register for Nairobi's most competitive inter-company football tournament. 32 teams compete across two days in a group stage + knockout format on professional 5-a-side turf pitches. Referees provided. Trophies and medals for top 3 finishers. Post-tournament BBQ and awards ceremony. Registration closes 2 weeks before the event.",
    date: "2025-07-12",
